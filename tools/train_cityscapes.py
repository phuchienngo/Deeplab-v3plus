...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--data_root_path', type=str, default="./data/Cityscapes",
                            help="the root path of dataset")
    arg_parser.add_argument('--checkpoint_dir', default=os.path.abspath('..') + "/checkpoints/",
                            help="the path of ckpt file")
    arg_parser.add_argument('--result_filepath', default="./data/Cityscapes/Results/",
                            help="the filepath where mask store")
    arg_parser.add_argument('--loss_weights_dir', default="./data/Cityscapes/pretrained_weights/")
